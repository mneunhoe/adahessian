...
class Adahessian_sls(Optimizer):
    ...
    def __init__(self, params, lr=0.15, betas=(0.9, 0.999), eps=1e-4,
                 weight_decay=0, hessian_power=1, line_search = True, line_search_fn = "armijo"):
        if not 0.0 <= lr:
        ...
        defaults = dict(lr=lr, betas=betas, eps=eps,
                        weight_decay=weight_decay, hessian_power=hessian_power, line_search=line_search, line_search_fn=line_search_fn)
